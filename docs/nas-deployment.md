...
| Complains a setting is unset that you deliberately removed | The installed script checks settings before it can replace itself. Re-run the bootstrap `curl` once, then update as usual |
